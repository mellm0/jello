...
module.exports = function (gulp, $, $env) {
    var exports = {},
        ...
        debug = function() {
            return $.util.env.debug && $helpers.require('debug') !== null ? function () {
                return $helpers.require('debug')();
            } : $.util.noop;
        },

        cache = function(key) {
            return !$.util.env.noCache && $helpers.require('cache') !== null ? function () {
                return $helpers.require('cache')(key);
            } : $.util.noop;
        },

        remember = function(key) {
            return !$.util.env.noCache && $helpers.require('remember') !== null ? function () {
                return $helpers.require('remember')(key);
            } : $.util.noop;
        };
